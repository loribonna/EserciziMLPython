...
class MultiLayerPerceptron:
    def __init__(self, layer_structure: list, data: Tensor, targets: Tensor, is_training: Tensor, learning_rate=0.01, use_tf_model=True):
        if(use_tf_model):
            self.model = self.inference_tf(data, is_training, layer_structure)
        else:
            self.model = self.inference(data, is_training, layer_structure)
